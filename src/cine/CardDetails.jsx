    ...
    <div className='fixed top-0 left-0 w-screen h-screen z-50 bg-black/60 backdrop-blur-sm'>
      <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[790px] p-4 max-h-[90vh] overflow-auto'>
        <div className='bg-white shadow-md dark:bg-[#12141D] rounded-2xl overflow-hidden p-5 md:p-9'>
          <h2 className='text-2xl lg:text-[30px] mb-10 font-bold text-white'>
            Your Carts
          </h2>
          <div className='space-y-8 lg:space-y-12 max-h-[450px] overflow-auto mb-10 lg:mb-14'>
            {
                cartData.map(item => (<div key={item.id} className='grid grid-cols-[1fr_auto] gap-4 text-white'>
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='max-md:text-xl text-gray-200'>
                        {item.genre}
                        </p>
                        <span className='max-md:text-xl'>${item.price}</span>
                      </div>
                    </div>
